...
class CrossAttnUpBlock2D(nn.Module):
    ...
    def forward(
        ...
        for resnet, attn in zip(self.resnets, self.attentions):
            ...
            # -- This is where A Tale of Two Features (Zhang et al.) extract the semantic feature --
            cache_hidden_states = cache_hidden_states + (hidden_states,)
            ...
            if self.training and self.gradient_checkpointing:
                ...
                # -- This is where Diffusion Hyperfeatures (Luo et al.) extract the semantic features
        ...
        return hidden_states, cache_hidden_states
